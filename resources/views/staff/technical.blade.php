...
<head>
    ...
    <title>Technical Dashboard - UAUT Staff Risk Management</title>
    ...
    <div class="flex h-screen">
        <aside class="w-72 bg-primary-black text-primary-white p-6 flex flex-col">
            <div class="flex items-center mb-8">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xs text-gray-400">Technical Dashboard</p>
                </div>
            </div>
            <div class="mb-8">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-primary-black">Technical Risk Dashboard</h1>
            ...
            <section id="reported-risks" class="bg-primary-white p-6 rounded-xl shadow-md border border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-primary-black">Technical Reported Risks</h2>
                    </div>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        @if (in_array($risk->status, ['pending', 'in_progress']))
                                            <form action="{{ route('technical.progress', $risk) }}" method="POST" class="mb-2">
                                                @csrf
                                            ...
                                            <form action="{{ route('technical.resolve', $risk) }}" method="POST" class="mb-2">
                                                @csrf
                                            ...
                                            @if ($risk->urgency == 'high')
                                                <form action="{{ route('technical.suggest', $risk) }}" method="POST">
                                                    @csrf

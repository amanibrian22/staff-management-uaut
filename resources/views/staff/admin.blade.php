...
<head>
    ...
    <title>Admin Dashboard - UAUT Staff Risk Management</title>
    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-primary-black">Admin Risk Dashboard</h1>
            ...
            <section id="reported-risks" class="bg-primary-white p-6 rounded-xl shadow-md border border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-primary-black">All Reported Risks</h2>
                    </div>
